...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        if(u==null || !u.getJiaoshimima().equals(EncryptUtil.md5(password))) {
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
		...
		jiaoshi.setId(uId);
        jiaoshi.setJiaoshimima(EncryptUtil.md5(jiaoshi.getJiaoshimima()));
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setJiaoshimima(EncryptUtil.md5("123456"));
    ...
    public R update(@RequestBody JiaoshiEntity jiaoshi, HttpServletRequest request){
        ...
        if(StringUtils.isNotBlank(jiaoshi.getJiaoshimima()) && !jiaoshi.getJiaoshimima().equals(jiaoshiEntity.getJiaoshimima())) {
            jiaoshi.setJiaoshimima(EncryptUtil.md5(jiaoshi.getJiaoshimima()));
        }
